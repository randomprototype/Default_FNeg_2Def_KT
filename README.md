This repository is relative to the web-application for the cost-rate computation for an hybrid inspection and age-based (where would be the last inspection moment) maintenance policy.
